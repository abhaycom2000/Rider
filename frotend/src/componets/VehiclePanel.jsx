...
function VehiclePanel(props) {
    return (
        <div>
            ...
            <div onClick={()=> props.setConfirmRidePanel(true)} className='items-center border-2 mb-2 active:border-black rounded-2xl p-3 w-full  flex justify-between'>
            ...
            <div onClick={()=> props.setConfirmRidePanel(true)} className='items-center border-2 mb-2 active:border-black rounded-2xl p-3 w-full  flex justify-between'>
                ...
                <h2 className='text-lg font-semibold'>135.20</h2>
            </div>
        </div>
    )
}
