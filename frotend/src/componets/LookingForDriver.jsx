...
const LookingForDriver = (props) => {
    return (
        <div>
            <h5 className='absolute top-0 p-1 text-center w-[93%]' onClick={() => props.setVehicleFound(false)}><i className="text-3xl text-gray-300 ri-arrow-down-wide-line pt-4"></i></h5>
